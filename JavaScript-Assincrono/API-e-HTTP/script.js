// API
// Aplication - Um servidor, aplicativo, objeto JavaScript ou qualquer outra coisa que você interaja através de comandos. Ao digitar uma URL, estamos utilizando a API do browser para se comunicar com a API do servidor.
...
//-----------------------------------------------------------------------------------
// Exemplos de API's
// Github - https://api.github.com/users/origamid / https://api.github.com/users/origamid/followers
// Array / Element
// [].map();
// [].filter();
// Element.classList;
// Element.attributes;
// Tempo - https://www.metaweather.com/api/location/455825/ / https://github.com/toddmotto/public-apis
//-----------------------------------------------------------------------------------
// HTTP
...
const url0 = 'https://jsonplaceholder.typicode.com/posts/';
const options = {
  method: 'POST',
  headers: {
...
// POST - Utilizado para criar posts, usuários e etc.Utilizado para criar posts, usuários e etc.
...
// Content-Type - Tipo de conteúdo. Ex: text/html; charset=utf-8. Indicar o tipo de arquivo principalmente em métodos POST e PUT.
